-- =====================================================================
-- APLICAR EN SUPABASE (SQL Editor o psql) — lote 20260806
--
-- Un pago posterior al corte ahora BAJA la deuda de ese corte, y las
-- funciones SECURITY DEFINER dejan de estar abiertas al rol `anon`.
-- Sólo redefine funciones: no toca datos, columnas ni triggers, y es
-- reejecutable sin efectos.
--
-- ANTES DE EJECUTAR:  ./scripts/db-backup.sh
-- PROBAR ANTES:       ./scripts/db-test.sh   (casos 12 a 16)
-- PARA REVERTIR:      supabase/rollback/20260806_down_all.sql
--
-- No hay reparación de datos que hacer: los saldos ya eran correctos,
-- lo que estaba mal era lo que se reportaba sobre ellos.
-- =====================================================================


-- ============================================================
-- 20260806000021_statement_payments_and_scope.sql
-- ============================================================
-- =====================================================================
